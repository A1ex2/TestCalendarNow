            ...
            if (i < numRows) {
                ...
                for (int c = 0; c < week.size(); c++) {
                    ...
                    if (subTitle != null && !cellView.getSubTitleTextView().getText().equals(subTitle.getTitle())) {
                        ...
                        TextView sub = cellView.getSubTitleTextView();
                        sub.setTextColor(Color.RED);
                        sub.setTypeface(sub.getTypeface(), Typeface.BOLD_ITALIC);

                        TextView data = cellView.getDayOfMonthTextView();
                        data.setTextColor(Color.RED);
                        data.setTypeface(data.getTypeface(), Typeface.BOLD_ITALIC);
                    }

                    if (cell.isToday()){
                        TextView data = cellView.getDayOfMonthTextView();
                        data.setTypeface(data.getTypeface(), Typeface.BOLD);
